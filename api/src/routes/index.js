...
export default (app) => {
  ...
  /* Classes */
  app.get('/classes', authBearer(), C.Classes.list)
  app.post('/classes', authBearer(), C.Classes.create)
  app.get('/classes/:classId', authBearer(), C.Classes.find)
  app.put('/classes/:classId', authBearer(), C.Classes.update)
  app.delete('/classes/:classId', authBearer(), C.Classes.destroy)
